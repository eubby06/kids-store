...
// Mock cart data structure mirroring a real Laravel inertia prop payload
                            ...
                            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                                <ul className="divide-y divide-gray-200">
                                    {cartItems.map((item) => (
                                        ...
                                        >
                                            {/* Product Thumbnail */}
                                            <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl border border-gray-100 bg-gray-100">
                                                <img
                                                    src={item.image}
                                                    alt={item.name}
