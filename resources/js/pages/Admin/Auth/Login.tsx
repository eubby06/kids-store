            ...
            <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-100 bg-white p-8 shadow-sm">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                        Contact your administrator if you don't have an
                        account.{' '}
                    </p>
                </div>
                ...
                {status && (
                    <div className="rounded-lg bg-emerald-50 p-4 text-sm font-medium text-emerald-600">
                        {status}
                    </div>
                )}
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div className="flex items-center">
                        ...
                        <label
                            htmlFor="remember"
                            className="ml-2 block text-sm text-slate-600 select-none"
                        >
                            Remember me
                        </label>
                    </div>
