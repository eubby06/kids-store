...
export default function ProductList({ products = [] }: ProductListProps) {
    return (
        <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <h2 className="text-xl font-bold tracking-tight text-slate-900 border-b border-slate-200 pb-4">Products</h2>
                    ...
                    <div key={product.id} className="group relative flex flex-col justify-between overflow-hidden rounded-2xl bg-white border border-slate-100 p-3 shadow-sm hover:shadow-md transition">
                        ...
                        <div className="mt-4 flex flex-col justify-between flex-1">
                            ...
                            <div className="mt-3 flex items-center justify-between z-20">
                                ...
                                <button 
                                    type="button"
                                    className="rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-indigo-600 transition"
                                    onClick={(e) => {
                                        e.preventDefault();
